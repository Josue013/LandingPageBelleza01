  ...
  return (
    <div className={cn("group relative aspect-4/3 w-full", className)}>
      <div className="perspective-distant transform-3d">
        ...
        <div className="absolute sm:-inset-8 rounded-3xl bg-linear-to-r from-primary/10 via-pink-500/10 to-rose-500/10 opacity-0 group-hover:opacity-100 transition-all duration-1000 blur-2xl" />
